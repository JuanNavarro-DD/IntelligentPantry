...
//    stepper2.setSpeed(data[2]);
//    stepper3.setSpeed(data[2]);
//    stepper4.setSpeed(data[2]);
//    stepper1.setAcceleration(data[3]);
//    stepper2.setAcceleration(data[3]);
//    stepper3.setAcceleration(data[3]);
//    stepper4.setAcceleration(data[3]);
//
